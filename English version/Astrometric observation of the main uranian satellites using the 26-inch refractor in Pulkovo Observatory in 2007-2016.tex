...
Observations processing and coordinates measurement were performed with the IZMCCD software package (www.izmccd.puldb.ru, Izmailov et al., 1998). In case of distortion of šthe satellite image by planet halo the procedure of approximation and subtraction of the halo signals was applied.\par
Firstly the certain area $A$ with the image distorted by planet halo was selected. In that area the uniform grid with 4 nodes on a vertical and horizontal was allocated. For each node the system of equeations (\ref{2}) was formed and solved relatively $a$, $b$, $c$ and $d$ by the least square method.\par
...
$(x_0, y_0)$ -- coordinates of the node,\\
$i$ -- the number of equation,\\
($x_i$, $y_i$) -- coordinates of the coresponding pixel in the area A,\\
$I(r_i)$ -- a value of brightness in the pixel.\par
...
\begin{table}
\begin{center}
\caption{Halo subtracting efficience}
\label{halo_sub}
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
   &$(O-C)_\alpha$&$(O-C)_\delta$&SEM $\alpha$ &SEM $\delta$ & RMS $\alpha$ & RMS $\delta$\\
\hline
Ariel& -0.035 & -0.015 & 0.026 & 0.042 & 0.059 & 0.094\\
Umbriel & 0.016 & -0.002 & 0.027 & 0.099 & 0.061 & 0.221\\
Titania& -0.003 & 0.008 & 0.005 & 0.007 & 0.010 & 0.016\\
Oberon & 0.009 & 0.009 & 0.003 & 0.012 & 0.006 & 0.027 \\
\hline
Ariel& 1.888 & -1.099 & 1.596 & 0.309 & 3.568 & 0.692\\
Umbriel & -2.024 & -0.442 & 1.736 & 0.446 & 3.882 & 0.998\\
Titania& 0.006 & 0.064 & 0.005 & 0.010 & 0.012 & 0.023\\
Oberon & 0.081 & -0.045 & 0.006 & 0.011 & 0.012 & 0.026 \\
\hline
\end{tabular}
\end{center}
\end{table}

We determined the photocenters of satellites and reference stars images using approximation of image profile with the Lorenz function.\par
...
We show this effect by calculating the K coefficient. Let K be a ratio of the number of normal positions obtained during an observational season to the number of nights in this season. The observational season is a period of time from the end of August to the beginning of January. šFigure (\ref{fig:K}) illustrates increasing of this ratio.\par
...
\begin{table}
\begin{center}
\caption{Mean O-C differences of RA ($\alpha$) and DEC ($\delta$) and errors}
\label{mean_OC_errs}
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
   &$(O-C)_\alpha$&$(O-C)_\delta$&SEM $\alpha$ &SEM $\delta$ & RMS $\alpha$ & RMS $\delta$\\
